...
describe('buildFilter', () => {
    ...
    it('should build single condition', () => {
        const conditions: FilterCondition[] = [{ field: 'name', operator: '=', value: 'iPhone' }];
    ...
    it('should handle boolean values', () => {
        const conditions: FilterCondition[] = [{ field: 'archived', operator: '=', value: false }];
        expect(buildFilter(conditions)).toBe('archived=false');
    });

    it('should handle numeric values', () => {
        const conditions: FilterCondition[] = [{ field: 'quantity', operator: '>=', value: 100 }];
