    ...
    describe('getOrders', () => {
        ...
        it('should filter by agentId', async () => {
            ...
            expect(params.get('filter')).toContain(
                'agent=https://api.moysklad.ru/api/remap/1.2/entity/counterparty/agent-uuid-123'
            );
        });
        ...
        it('should filter by stateId', async () => {
            ...
            const params = mockClient.getList.mock.calls[0][1] as URLSearchParams;
            expect(params.get('filter')).toContain(
                'state=https://api.moysklad.ru/api/remap/1.2/entity/customerorder/metadata/states/state-uuid-123'
            );
        });
    ...
    describe('createOrder', () => {
        it('should create order with positions', async () => {
            ...
            const result = await createOrder({
                ...
                agentId: 'agent-456',
                positions: [{ productId: 'product-789', quantity: 1, price: 99999 }],
            });
        ...
        it('should send correct request body', async () => {
            ...
            await createOrder({
                ...
                agentId: 'agent-456',
                storeId: 'store-789',
                positions: [{ productId: 'prod-1', quantity: 2, price: 1000, discount: 5 }],
